...
@section('header-title', 'Welcome to the Post Edit Page')
    ...
    <div class="max-w-3xl mx-auto py-8 px-4">
        ...
        <div class="relative bg-white rounded-lg shadow-xl w-full max-w-3xl mx-4 z-10">
            <div class="flex justify-between items-center p-4 border-b">
                <h2 class="text-lg font-medium">Edit Post</h2>
            </div>

            <div class="p-6">
                <form action="{{ route('post.update', $post->id) }}" method="POST" novalidate class="space-y-6">
                    @csrf
                    @method('PUT')
